...
export const COURSE_TOPICS: CourseEntry[] = [
  {
    ...
    topics: [
      // ── Foundations ─────────────────────────────────────────────────────────
      { slug: 'jvm-basics',            title: 'JVM Architecture',              duration: '30 min' },
      { slug: 'data-types',            title: 'Data Types & Primitives',       duration: '25 min' },
      { slug: 'variables-casting',     title: 'Variables & Type Casting',      duration: '25 min' },
      { slug: 'operators',             title: 'Operators',                     duration: '20 min' },
      { slug: 'control-flow',          title: 'Control Flow',                  duration: '25 min' },
      { slug: 'loops',                 title: 'Loops',                         duration: '25 min' },
      { slug: 'methods',               title: 'Methods',                       duration: '30 min' },
      { slug: 'arrays',                title: 'Java Arrays',                   duration: '30 min' },
      // ── Strings ──────────────────────────────────────────────────────────────
      { slug: 'strings',               title: 'Strings & StringBuilder',       duration: '35 min' },
      { slug: 'string-pool',           title: 'String Pool & Interning',       duration: '25 min' },
      { slug: 'wrapper-classes',       title: 'Wrapper Classes & Autoboxing',  duration: '30 min' },
      // ── OOP ──────────────────────────────────────────────────────────────────
      ...
      { slug: 'enums',                 title: 'Enumerations (enum)',           duration: '30 min' },
      { slug: 'nested-classes',        title: 'Nested & Inner Classes',        duration: '30 min' },
      { slug: 'final-static',          title: 'final & static Keywords',       duration: '25 min' },
      { slug: 'object-class',          title: 'The Object Class',              duration: '25 min' },
      { slug: 'equals-hashcode',       title: 'equals() & hashCode()',         duration: '30 min' },
      { slug: 'immutable-classes',     title: 'Immutable Classes',             duration: '30 min' },
      // ── Exceptions ───────────────────────────────────────────────────────────
      { slug: 'exceptions',            title: 'Exception Handling',            duration: '30 min' },
      { slug: 'try-resources',         title: 'Try-with-Resources',            duration: '25 min' },
      // ── Collections ──────────────────────────────────────────────────────────
      ...
      { slug: 'collections-queue',     title: 'Collections: Queue & Deque',    duration: '30 min' },
      { slug: 'iterator-iterable',     title: 'Iterator & Iterable',           duration: '25 min' },
      { slug: 'comparable-comparator', title: 'Comparable & Comparator',       duration: '30 min' },
      // ── Generics & Functional ────────────────────────────────────────────────
      { slug: 'generics',              title: 'Generics',                      duration: '30 min' },
      { slug: 'functional-interfaces', title: 'Functional Interfaces',         duration: '30 min' },
      { slug: 'lambdas',               title: 'Lambda Expressions',            duration: '30 min' },
      { slug: 'method-references',     title: 'Method References',             duration: '25 min' },
      { slug: 'streams',               title: 'Streams API',                   duration: '40 min' },
      { slug: 'optional',              title: 'Optional Class',                duration: '25 min' },
      // ── Modern Java ──────────────────────────────────────────────────────────
      { slug: 'date-time',             title: 'Date & Time API',               duration: '35 min' },
      { slug: 'annotations',           title: 'Annotations',                   duration: '30 min' },
      { slug: 'var-type-inference',    title: 'var & Type Inference',          duration: '20 min' },
      { slug: 'pattern-matching',      title: 'Pattern Matching',              duration: '30 min' },
      { slug: 'text-blocks',           title: 'Text Blocks',                   duration: '20 min' },
      { slug: 'records-sealed',        title: 'Records & Sealed Classes',      duration: '25 min' },
      // ── Advanced ─────────────────────────────────────────────────────────────
      { slug: 'serialization',         title: 'Serialization',                 duration: '30 min' },
      { slug: 'cloning',               title: 'Object Cloning',                duration: '25 min' },
      { slug: 'java-memory-model',     title: 'Java Memory Model',             duration: '35 min' },
      { slug: 'garbage-collection',    title: 'Garbage Collection',            duration: '35 min' },
      { slug: 'reflection',            title: 'Reflection API',                duration: '35 min' },
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'dp-flyweight',  title: 'Flyweight',                 duration: '30 min' },
      { slug: 'dp-facade',     title: 'Facade',                    duration: '25 min' },
      { slug: 'dp-composite',  title: 'Composite',                 duration: '30 min' },
      { slug: 'dp-mediator',   title: 'Mediator',                  duration: '30 min' },
      { slug: 'dp-prototype',  title: 'Prototype',                 duration: '30 min' },
      { slug: 'dp-bridge',     title: 'Bridge',                    duration: '30 min' },
      { slug: 'dp-iterator',   title: 'Iterator',                  duration: '25 min' },
      { slug: 'dp-memento',    title: 'Memento',                   duration: '30 min' },
      { slug: 'dp-visitor',    title: 'Visitor',                   duration: '30 min' }
    ]
  },
  {
    slug: 'modern-java',

...
@Component({
  ...
  imports: [RouterLink, IonContent, IonHeader, IonToolbar, IonTitle],
  template: `
  ...
  styles: `
    ...
    .info-title { font-size: 0.88rem; font-weight: 700; color: #0f172a; }
    ...
    .name { font-size: 0.86rem; font-weight: 700; color: #0f172a; }
    .cat { font-size: 0.62rem; color: #94a3b8; font-weight: 500; }

    .meta { display: flex; align-items: center; gap: 10px; margin-top: 4px; }
    .meta-item { font-size: 0.6rem; color: #64748b; font-weight: 500; }

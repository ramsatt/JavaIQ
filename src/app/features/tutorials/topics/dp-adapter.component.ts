...
@Component({
    ...
    <app-tutorial-layout title="Adapter" subtitle="Make incompatible interfaces work together. Class adapter, object adapter, and real-world examples." badge="DESIGN PATTERNS" gradient="linear-gradient(135deg, #0369a1, #38bdf8)">
      <section class="section">
        ...
        <div class="topic-hero-container">
          <img src="/assets/images/topics/dp-adapter.png" alt="Adapter Pattern Visualized" class="topic-hero-image" />
        </div>
  ...
  styles: `
    ...
    .section-heading { display: flex; align-items: center; gap: 12px; font-size: 1.4rem; font-weight: 800; color: #0f172a; margin: 0 0 20px; padding-bottom: 14px; border-bottom: 1px solid #e2e8f0; } .icon-sky { color: #0284c7; } .icon-indigo { color: #4f46e5; }

...
@Component({
    ...
    <app-tutorial-layout title="Builder" subtitle="Step-by-step object construction. Fluent API, immutable objects, and Lombok @Builder." badge="DESIGN PATTERNS" gradient="linear-gradient(135deg, #b45309, #fbbf24)">
      <section class="section">
        ...
        <div class="topic-hero-container">
          <img src="/assets/images/topics/dp-builder.png" alt="Builder Pattern Visualized" class="topic-hero-image" />
        </div>
  ...
  styles: `
    ...
    .section-heading { display: flex; align-items: center; gap: 12px; font-size: 1.4rem; font-weight: 800; color: #0f172a; margin: 0 0 20px; padding-bottom: 14px; border-bottom: 1px solid #e2e8f0; } .icon-amber { color: #d97706; } .icon-indigo { color: #4f46e5; }

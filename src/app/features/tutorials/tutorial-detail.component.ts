...
export class TutorialDetailComponent {
  ...
  private courses: Record<string, CourseData> = {
    'core-java': {
      ...
      themeColor: '#f59e0b',
      topics: [
        { slug: 'jvm-basics', title: 'JVM Architecture', description: 'Class loading, memory areas (heap, stack, metaspace), JIT compilation, and garbage collection overview', iconName: 'cpu', duration: '35 min' },
        ...
        { slug: 'variables-casting', title: 'Variables & Type Casting', description: 'Variable scope, var keyword, widening vs narrowing conversion', iconName: 'code', duration: '30 min' },
        { slug: 'operators', title: 'Operators', description: 'Arithmetic, relational, logical, bitwise operators, and precedence rules', iconName: 'zap', duration: '30 min' },
        { slug: 'control-flow', title: 'Control Flow', description: 'if-else, classic switch, and modern switch expressions (Java 14+)', iconName: 'git-branch', duration: '30 min' },
        { slug: 'loops', title: 'Loops & Iteration', description: 'for, while, do-while, enhanced for-each, break, continue, labeled loops', iconName: 'refresh-cw', duration: '30 min' },
        { slug: 'methods', title: 'Methods & Varargs', description: 'Method anatomy, overloading, pass-by-value, varargs, and recursion', iconName: 'code', duration: '35 min' },
        ...
        { slug: 'string-pool', title: 'String Pool & Interning', description: 'How the JVM deduplates strings, intern(), == vs equals(), memory impact', iconName: 'database', duration: '25 min' },
        { slug: 'wrapper-classes', title: 'Wrapper Classes & Autoboxing', description: 'Integer, Long, Double, autoboxing pitfalls, integer cache (-128 to 127)', iconName: 'box', duration: '25 min' },
        ...
        { slug: 'enums', title: 'Enums', description: 'Enum fields, methods, Planet explorer, EnumSet, EnumMap, singleton pattern', iconName: 'list', duration: '30 min' },
        { slug: 'nested-classes', title: 'Nested & Inner Classes', description: 'Static nested, inner, anonymous, and local classes with memory diagram', iconName: 'layers', duration: '30 min' },
        { slug: 'final-static', title: 'final & static Keywords', description: 'final variables/methods/classes, static members, constants, class-level state', iconName: 'lock', duration: '25 min' },
        { slug: 'object-class', title: 'java.lang.Object', description: 'equals/hashCode contract, toString, clone, Records vs Lombok', iconName: 'box', duration: '35 min' },
        { slug: 'equals-hashcode', title: 'equals() & hashCode() Contract', description: 'Correct overriding, symmetry/transitivity rules, HashMap behaviour', iconName: 'check-circle', duration: '30 min' },
        { slug: 'immutable-classes', title: 'Immutable Classes', description: 'Design rules, defensive copies, String/BigDecimal examples, thread safety', iconName: 'lock', duration: '25 min' },
        ...
        { slug: 'try-resources', title: 'try-with-resources', description: 'AutoCloseable, suppressed exceptions, multi-resource try, cleaner resource management', iconName: 'shield', duration: '20 min' },
        ...
        { slug: 'collections-queue', title: 'Collections: Queue & Deque', description: 'Queue, Deque, ArrayDeque, PriorityQueue, stack operations', iconName: 'list', duration: '25 min' },
        { slug: 'iterator-iterable', title: 'Iterator & Iterable', description: 'Custom iteration, for-each internals, ListIterator, fail-fast behaviour', iconName: 'refresh-cw', duration: '25 min' },
        { slug: 'comparable-comparator', title: 'Comparable & Comparator', description: 'Natural ordering, custom sort, Comparator chaining, thenComparing', iconName: 'sliders', duration: '25 min' },
        ...
        { slug: 'date-time', title: 'Date & Time API', description: 'LocalDate, LocalDateTime, ZonedDateTime, Duration, Period, DateTimeFormatter', iconName: 'clock', duration: '30 min' },
        { slug: 'annotations', title: 'Annotations', description: 'Built-in annotations, custom annotations, retention policies, reflection-based processing', iconName: 'tag', duration: '25 min' },
        { slug: 'var-type-inference', title: 'var & Type Inference', description: 'Local variable type inference, when to use var, limitations and pitfalls', iconName: 'code', duration: '20 min' },
        { slug: 'pattern-matching', title: 'Pattern Matching', description: 'instanceof pattern matching, switch expressions, sealed class patterns (Java 16–21)', iconName: 'git-branch', duration: '30 min' },
        { slug: 'text-blocks', title: 'Text Blocks', description: 'Multi-line strings, indentation stripping, escape sequences, JSON/SQL use cases', iconName: 'align-left', duration: '20 min' },
        ...
        { slug: 'serialization', title: 'Serialization', description: 'Serializable, ObjectOutputStream, serialVersionUID, transient, security concerns', iconName: 'save', duration: '25 min' },
        { slug: 'cloning', title: 'Object Cloning', description: 'Cloneable, shallow vs deep copy, copy constructors, clone() pitfalls', iconName: 'copy', duration: '25 min' },
        { slug: 'java-memory-model', title: 'Java Memory Model', description: 'Heap vs stack, happens-before, visibility, volatile, memory barriers', iconName: 'cpu', duration: '30 min' },
        { slug: 'garbage-collection', title: 'Garbage Collection', description: 'GC algorithms, generational GC, G1, ZGC, tuning flags, memory leaks', iconName: 'trash-2', duration: '35 min' },
        { slug: 'reflection', title: 'Reflection API', description: 'Class metadata, dynamic method invocation, field access, use cases and performance cost', iconName: 'eye', duration: '30 min' },

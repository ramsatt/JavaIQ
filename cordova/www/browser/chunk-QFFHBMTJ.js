// src/app/data/core-java.ts
var CORE_JAVA_QUESTIONS = [
  {
    id: 1001,
    category: "Core Java",
...
// src/app/data/spring-boot.ts
var SPRING_BOOT_QUESTIONS = [
  {
    id: 4,
...
// src/app/data/hibernate.ts
var HIBERNATE_QUESTIONS = [
  {
    id: 6,
    category: "Hibernate",
...
// src/app/data/spring-reactive.ts
var SPRING_REACTIVE_QUESTIONS = [
  {
    id: 8,
...
// src/app/data/microservices.ts
var MICROSERVICES_QUESTIONS = [
  {
    id: 10,
...
// src/app/data/multithreading.ts
var MULTITHREADING_QUESTIONS = [
  {
    id: 59,
...
// src/app/data/reactive-programming.ts
var REACTIVE_PROGRAMMING_QUESTIONS = [
  {
    id: 112,
...
// src/app/data/coding-questions.ts
...
boolean isPal = (original == res);`,
  ...
  },
  {
    ...
    coreConceptDescription: "An n-digit Armstrong (narcissistic) number equals the sum of each digit raised to the nth power. 153 = 1\xB3 + 5\xB3 + 3\xB3. Uses the same digit extraction pattern.",
...
boolean isArmstrong = (original == res);`,
    subConcepts: [
      { title: "Definition", description: "<b>Sum of digits^n = number</b> where n is the digit count. 153 = 1\xB3+5\xB3+3\xB3 = 1+125+27 = 153." },
...
while (num > 0) {
  ...
  },
  {
    ...
    coreConceptDescription: "Factorial n! = 1 \xD7 2 \xD7 3 \xD7 ... \xD7 n. Iterative approach is O(n) time, O(1) space. For large n, use BigInteger to avoid overflow (13! exceeds int range).",
    code: `int n = 5, fact = 1;
for (int i = 1; i <= n; i++) {
    fact *= i;
}`,
...
//# sourceMappingURL=chunk-QFFHBMTJ.js.map

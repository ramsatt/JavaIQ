import{a as v,b as D,c as O}from"./chunk-5NK5W44O.js";import{Cb as f,Gb as h,Ib as m,Pa as a,Qb as u,Tb as n,Ub as p,aa as g,ab as x,ba as S,na as l,qb as E,rb as C,sb as o,tb as t,ub as e,vb as c}from"./chunk-WSUICUG6.js";import"./chunk-NWJ5J3BN.js";var w=(s,d)=>d.name;function y(s,d){if(s&1){let i=f();t(0,"div",16),h("click",function(){let I=g(i).$implicit,b=m();return S(b.selectState(I.name))}),t(1,"span",17),n(2),e(),t(3,"span",18),n(4),e()()}if(s&2){let i=d.$implicit,r=m();u("active",r.activeState()===i.name),a(2),p(i.icon),a(2),p(i.name)}}var P=class s{activeState=l("");stateInfo=l("Click a state to see allowed transitions.");orderStates=l([{name:"CREATED",icon:"\u{1F4DD}"},{name:"PAID",icon:"\u{1F4B3}"},{name:"SHIPPED",icon:"\u{1F4E6}"},{name:"DELIVERED",icon:"\u2705"},{name:"CANCELLED",icon:"\u274C"}]);codeIntro=`// Without State: giant switch/if-else

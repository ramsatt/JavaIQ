import{a as T,b as y,c as E}from"./chunk-3MUY7VVQ.js";import{$a as r,Ba as i,Ka as h,Za as f,_a as x,ab as t,ba as u,bb as e,ca as g,cb as d,jb as b,lb as v,nb as m,oa as l,vb as C,yb as n,zb as p}from"./chunk-YTAFWVC7.js";import"./chunk-NWJ5J3BN.js";var k=(s,c)=>c.name;function S(s,c){if(s&1){let o=b();t(0,"div",16),v("click",function(){let _=u(o).$implicit,w=m();return g(w.select(_.name))}),t(1,"span",17),n(2),e(),t(3,"span",18),n(4),e()()}if(s&2){let o=c.$implicit,a=m();C("active",a.active()===o.name),i(2),p(o.icon),i(2),p(o.name)}}var M=class s{active=l("");status=l("Click a state to learn about the thread lifecycle.");states=l([{name:"NEW",icon:"\u{1F195}"},{name:"RUNNABLE",icon:"\u25B6\uFE0F"},{name:"BLOCKED",icon:"\u{1F6AB}"},{name:"WAITING",icon:"\u23F8\uFE0F"},{name:"TERMINATED",icon:"\u{1F3C1}"}]);codeIntro=`// Way 1: Extend Thread

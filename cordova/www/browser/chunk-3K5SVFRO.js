import{a as M,b as y,c as E}from"./chunk-FZG5ZG77.js";import{$ as g,Fb as C,Hb as t,Ib as l,Ma as i,Xa as f,_ as u,ka as d,kb as h,lb as b,mb as a,nb as n,ob as e,pb as s,vb as x,wb as v,xb as m}from"./chunk-5DVJCJ5O.js";import"./chunk-NWJ5J3BN.js";var S=(p,c)=>c.path;function z(p,c){if(p&1){let o=x();n(0,"div",16),v("click",function(){let O=u(o).$implicit,P=m();return g(P.selectEp(O.path))}),n(1,"span",17),t(2),e(),n(3,"span",18),t(4),e()()}if(p&2){let o=c.$implicit,r=m();C("active",r.activeEp()===o.path),i(2),l(o.icon),i(2),l(o.path)}}var _=class p{activeEp=d("");status=d("Click an endpoint to see its response.");endpoints=d([{path:"/health",icon:"\u{1F49A}"},{path:"/metrics",icon:"\u{1F4CA}"},{path:"/info",icon:"\u2139\uFE0F"},{path:"/env",icon:"\u2699\uFE0F"},{path:"/beans",icon:"\u{1FAD8}"},{path:"/loggers",icon:"\u{1F4DD}"}]);codeIntro=`# application.yml
management:
  endpoints:
    web:
      exposure:

...
function IqDetailComponent_Conditional_11_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
...
function IqDetailComponent_Conditional_11_Conditional_8_For_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 33);
  }
}
function IqDetailComponent_Conditional_11_Conditional_8_For_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 34);
  }
}
function IqDetailComponent_Conditional_11_Conditional_8_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 31)(1, "div", 32);
    \u0275\u0275conditionalCreate(2, IqDetailComponent_Conditional_11_Conditional_8_For_5_Conditional_2_Template, 1, 0, "i", 33)(3, IqDetailComponent_Conditional_11_Conditional_8_For_5_Conditional_3_Template, 1, 0, "i", 34);
...
function IqDetailComponent_Conditional_11_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 15)(1, "div", 24);
    \u0275\u0275text(2, "TYPES");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 29);
    \u0275\u0275repeaterCreate(4, IqDetailComponent_Conditional_11_Conditional_8_For_5_Template, 7, 7, "div", 30, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const q_r2 = \u0275\u0275nextContext();
...
function IqDetailComponent_Conditional_11_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 15)(1, "div", 24);
    \u0275\u0275text(2, "CLASS HIERARCHY");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 36)(4, "div", 37)(5, "div", 38)(6, "div", 39);
    \u0275\u0275text(7, "Animal");
    \u0275\u0275elementEnd();
...
function IqDetailComponent_Conditional_11_Conditional_10_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 56);
  }
}
function IqDetailComponent_Conditional_11_Conditional_10_Conditional_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 57);
  }
}
function IqDetailComponent_Conditional_11_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section", 15)(1, "div", 24);
    \u0275\u0275text(2, "IMPLEMENTATION");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 48)(4, "div", 49)(5, "div", 50);
    \u0275\u0275element(6, "span", 51)(7, "span", 52)(8, "span", 53);
    \u0275\u0275elementStart(9, "span", 54);
    \u0275\u0275text(10, "Example.java");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "button", 55);
    \u0275\u0275listener("click", function IqDetailComponent_Conditional_11_Conditional_10_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r5);
      const q_r2 = \u0275\u0275nextContext();
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.copyCode(q_r2.code));
    });
    \u0275\u0275conditionalCreate(12, IqDetailComponent_Conditional_11_Conditional_10_Conditional_12_Template, 1, 0, "i", 56)(13, IqDetailComponent_Conditional_11_Conditional_10_Conditional_13_Template, 1, 0, "i", 57);
    \u0275\u0275elementEnd()();
...
function IqDetailComponent_Conditional_11_Conditional_11_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 61)(1, "div", 62);
    \u0275\u0275element(2, "i", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 64)(4, "h4", 65);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
...
function IqDetailComponent_Conditional_11_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 15)(1, "div", 24);
    \u0275\u0275text(2, "USE CASES");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 60);
    \u0275\u0275repeaterCreate(4, IqDetailComponent_Conditional_11_Conditional_11_For_5_Template, 8, 6, "div", 61, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const q_r2 = \u0275\u0275nextContext();
...
function IqDetailComponent_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "main", 9)(1, "header", 11)(2, "span", 12);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275element(4, "h1", 13);
    ...
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(7, IqDetailComponent_Conditional_11_Conditional_7_Template, 8, 1, "section", 15);
    \u0275\u0275conditionalCreate(8, IqDetailComponent_Conditional_11_Conditional_8_Template, 6, 0, "section", 15);
    \u0275\u0275conditionalCreate(9, IqDetailComponent_Conditional_11_Conditional_9_Template, 22, 0, "section", 15);
    \u0275\u0275conditionalCreate(10, IqDetailComponent_Conditional_11_Conditional_10_Template, 16, 2, "section", 15);
    \u0275\u0275conditionalCreate(11, IqDetailComponent_Conditional_11_Conditional_11_Template, 6, 0, "section", 15);
    \u0275\u0275elementStart(12, "div", 16)(13, "button", 17);
    \u0275\u0275listener("click", function IqDetailComponent_Conditional_11_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function IqDetailComponent_Conditional_11_Template_button_click_20_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r3 = \u0275\u0275nextContext();
...
function IqDetailComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
var IqDetailComponent = class _IqDetailComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IqDetailComponent, selectors: [["app-iq-detail"]], decls: 13, vars: 8, consts: [["translucent", "false", 1, "ion-no-border"], [1, "detail-toolbar"], ["slot", "start"], ["text", "", 2, "color", "white", 3, "defaultHref"], [1, "brand-title"], [1, "nav-position"], ["slot", "end"], [1, "bm-btn", 3, "click"], [1, "detail-content"], [1, "detail-main"], [1, "loading-state"], [1, "detail-header"], [1, "meta-badge"], [1, "detail-title", 3, "innerHTML"], [1, "detail-answer"], [1, "section-block"], [1, "nav-footer"], [1, "nav-btn", "nav-prev", 3, "click"], [1, "fa-solid", "fa-chevron-left", "nav-btn-icon"], [1, "nav-btn-label"], [1, "nav-progress-info"], [1, "nav-progress-text"], [1, "nav-btn", "nav-next", 3, "click"], [1, "fa-solid", "fa-chevron-right", "nav-btn-icon"], [1, "section-label"], [1, "definition-card"], [1, "def-icon"], [1, "fa-solid", "fa-lightbulb"], [1, "def-text"], [1, "pills-grid"], [1, "concept-pill", 3, "pill-static", "pill-dynamic"], [1, "concept-pill"], [1, "pill-header"], [1, "fa-solid", "fa-bolt", "pill-icon", "pill-icon-static"], [1, "fa-solid", "fa-arrows-spin", "pill-icon", "pill-icon-dynamic"], [1, "pill-desc", 3, "innerHTML"], [1, "uml-card"], [1, "uml-wrapper"], [1, "uml-box", "uml-parent"], [1, "uml-box-header"], [1, "uml-box-body"], [1, "uml-arrow"], [1, "uml-line"], [1, "uml-triangle"], [1, "uml-label"], [1, "uml-box", "uml-child"], [1, "uml-override-badge"], [1, "uml-box-header", "uml-child-header"], [1, "code-editor"], [1, "code-topbar"], [1, "code-dots"], [1, "dot", "dot-red"], [1, "dot", "dot-yellow"], [1, "dot", "dot-green"], [1, "code-filename"], [1, "copy-btn", 3, "click"], [1, "fa-solid", "fa-check", "copy-check"], [1, "fa-regular", "fa-copy"], [1, "code-body"], [1, "code-pre", 3, "innerHTML"], [1, "usecases-list"], [1, "usecase-card"], [1, "usecase-icon-wrap"], [1, "fa-solid"], [1, "usecase-body"], [1, "usecase-title"], [1, "usecase-desc"], [1, "fa-solid", "fa-circle-notch", "fa-spin"]], template: function IqDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "ion-buttons", 6)(8, "button", 7);
      \u0275\u0275listener("click", function IqDetailComponent_Template_button_click_8_listener() {
        return ctx.toggleBookmark();
      });
      \u0275\u0275element(9, "i");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(10, "ion-content", 8);
      \u0275\u0275conditionalCreate(11, IqDetailComponent_Conditional_11_Template, 24, 14, "main", 9)(12, IqDetailComponent_Conditional_12_Template, 4, 0, "div", 10);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_4_0;

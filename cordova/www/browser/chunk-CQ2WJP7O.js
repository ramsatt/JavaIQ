import{S as n}from"./chunk-GF54RO5Y.js";import{a as o}from"./chunk-QSPX3XV4.js";var h=new Function("specifier","return import(specifier)"),s=class t{async shareText(a,e,r){if(o.isNativePlatform())try{let{Share:c}=await h("@capacitor/share");await c.share({title:a,text:e,url:r,dialogTitle:a});return}catch{}if(typeof navigator<"u"&&navigator.share)try{await navigator.share({title:a,text:e,url:r});return}catch{}let i=r?`${e}

...
function IqListComponent_For_47_Template(rf, ctx) {
  if (rf & 1) {
...
var IqListComponent = class _IqListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _IqListComponent, selectors: [["app-iq-list"]], decls: 51, vars: 5, consts: [["translucent", "true", 1, "ion-no-border"], [1, "iq-toolbar"], ["slot", "start"], ["color", "light"], [1, "iq-brand"], [1, "brand-icon"], [1, "iq-page-content"], [1, "page-wrapper"], [1, "hero-section"], [1, "hero-glow"], [1, "hero-badge"], [1, "hero-title"], [1, "hero-accent"], [1, "hero-subtitle"], [1, "stats-bar"], [1, "stat-item"], [1, "stat-value"], [1, "stat-label"], [1, "stat-divider"], [1, "overall-progress-track"], [1, "overall-progress-bar"], [1, "section-header"], [1, "section-tag"], [1, "fa-solid", "fa-layer-group", "section-tag-icon"], [1, "topic-grid"], [1, "topic-card", 3, "routerLink", "--accent"], [1, "page-footer"], [1, "footer-text"], [1, "topic-card", 3, "routerLink"], [1, "topic-accent-line"], [1, "topic-card-inner"], [1, "topic-icon-wrap"], [1, "topic-fa-icon"], [1, "topic-info"], [1, "topic-name"], [1, "topic-count"], [1, "topic-arrow"], [1, "fa-solid", "fa-chevron-right"], [1, "topic-progress-track"], [1, "topic-progress-bar"]], template: function IqListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(13, "\u{1F4BC} Interview Prep");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "h1", 11);
      \u0275\u0275text(15, "Master Your");
      \u0275\u0275element(16, "br");
      \u0275\u0275elementStart(17, "span", 12);
      \u0275\u0275text(18, "Java Interview");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "p", 13);
      \u0275\u0275text(20, "Curated questions from top tech companies");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275element(43, "i", 23);
      \u0275\u0275text(44, " Browse Topics ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "div", 24);
      \u0275\u0275repeaterCreate(46, IqListComponent_For_47_Template, 14, 18, "a", 25, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(48, "div", 26)(49, "p", 27);
      \u0275\u0275text(50, "Built with \u2764\uFE0F for Java developers");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(24);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(IqListComponent, [{
    type: Component,
    args: [{ selector: "app-iq-list", changeDetection: ChangeDetectionStrategy.OnPush, imports: [RouterLink, IonContent, IonHeader, IonToolbar, IonTitle, IonButtons, IonMenuButton], template: `

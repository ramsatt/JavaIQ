...
function AchievementGalleryComponent_For_13_Conditional_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.formatDate(a_r1.unlockedAt));
  }
}
function AchievementGalleryComponent_For_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(10);
    \u0275\u0275domElementEnd();
    \u0275\u0275conditionalCreate(11, AchievementGalleryComponent_For_13_Conditional_11_Template, 2, 1, "span", 19);
    \u0275\u0275domElementEnd()();
  }
  if (rf & 2) {
    const a_r1 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classProp("badge-locked", !a_r1.unlockedAt);
    \u0275\u0275advance();
    \u0275\u0275styleProp("border-color", a_r1.unlockedAt ? a_r1.iconColor : "transparent");
    \u0275\u0275advance();
    \u0275\u0275classMap(a_r1.icon);
    \u0275\u0275styleProp("color", a_r1.unlockedAt ? a_r1.iconColor : "#94a3b8");
    \u0275\u0275advance();
    \u0275\u0275conditional(!a_r1.unlockedAt ? 3 : -1);
    \u0275\u0275advance(2);
    \u0275\u0275styleProp("color", ctx_r1.rarityColor(a_r1));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.rarityLabel(a_r1), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(a_r1.description);
    \u0275\u0275advance();
    \u0275\u0275conditional(a_r1.unlockedAt ? 11 : -1);
  }
}
var RARITY_LABEL = {
  common: "Common",
...
var AchievementGalleryComponent = class _AchievementGalleryComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AchievementGalleryComponent, selectors: [["app-achievement-gallery"]], decls: 14, vars: 4, consts: [[1, "gallery-page"], [1, "gallery-header"], [1, "back-btn", 3, "click"], [1, "bi", "bi-arrow-left"], [1, "header-text"], [1, "gallery-title"], [1, "gallery-sub"], [1, "overall-track"], [1, "overall-fill"], [1, "badge-grid"], [1, "badge-card", 3, "badge-locked"], [1, "badge-card"], [1, "badge-icon-wrap"], [1, "bi"], [1, "lock-overlay"], [1, "badge-info"], [1, "badge-rarity"], [1, "badge-name"], [1, "badge-desc"], [1, "badge-date"], [1, "bi", "bi-lock-fill", "lock-icon"]], template: function AchievementGalleryComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;819ebe949238948b9186321f65e906152e6a8da03c8e5d30247ed4f934ea479f;/Users/sathishkumarramalingam/projects/JavaIQ/.claude/worktrees/goofy-haibt/src/app/features/achievements/achievement-gallery.component.ts */\n.gallery-page {\n  min-height: 100vh;\n  background: var(--ion-background-color, #f8fafc);\n  padding: 0 0 40px;\n}\n:host-context(html.dark) .gallery-page {\n  background: #0f172a;\n}\n.gallery-header {\n  display: flex;\n  align-items: center;\n  gap: 14px;\n  padding: 56px 20px 20px;\n  background:\n    linear-gradient(\n      135deg,\n      #1B4332,\n      #2D6A4F);\n}\n.back-btn {\n  width: 38px;\n  height: 38px;\n  border-radius: 12px;\n  background: rgba(255, 255, 255, 0.15);\n  border: none;\n  color: #fff;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1rem;\n  flex-shrink: 0;\n}\n.header-text {\n  display: flex;\n  flex-direction: column;\n  gap: 2px;\n}\n.gallery-title {\n  font-size: 1.4rem;\n  font-weight: 900;\n  color: #fff;\n  margin: 0;\n}\n.gallery-sub {\n  font-size: 0.75rem;\n  font-weight: 600;\n  color: rgba(255, 255, 255, 0.6);\n  margin: 0;\n}\n.overall-track {\n  height: 4px;\n  background: rgba(27, 67, 50, 0.15);\n}\n.overall-fill {\n  height: 100%;\n  background:\n    linear-gradient(\n      90deg,\n      #d4a853,\n      #f5c84a);\n  transition: width 0.6s ease;\n}\n.badge-grid {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 12px;\n  padding: 20px 16px;\n}\n.badge-card {\n  background: var(--ion-card-background, #ffffff);\n  border-radius: 16px;\n  padding: 16px;\n  border: 1.5px solid rgba(0, 0, 0, 0.06);\n  box-shadow: 0 2px 8px rgba(0, 0, 0, 0.06);\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 10px;\n  text-align: center;\n  transition: all 0.2s;\n}\n:host-context(html.dark) .badge-card {\n  background: #1a2332;\n  border-color: rgba(255, 255, 255, 0.06);\n}\n.badge-card.badge-locked {\n  opacity: 0.5;\n  filter: grayscale(1);\n}\n.badge-icon-wrap {\n  position: relative;\n  width: 56px;\n  height: 56px;\n  border-radius: 16px;\n  background: rgba(0, 0, 0, 0.04);\n  border: 2px solid transparent;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-shrink: 0;\n}\n:host-context(html.dark) .badge-icon-wrap {\n  background: rgba(255, 255, 255, 0.05);\n}\n.badge-icon-wrap .bi {\n  font-size: 1.6rem;\n}\n.lock-overlay {\n  position: absolute;\n  inset: 0;\n  background: rgba(0, 0, 0, 0.45);\n  border-radius: 14px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.lock-icon {\n  font-size: 0.9rem;\n  color: rgba(255, 255, 255, 0.8);\n}\n.badge-info {\n  display: flex;\n  flex-direction: column;\n  gap: 3px;\n}\n.badge-rarity {\n  font-size: 0.6rem;\n  font-weight: 800;\n  text-transform: uppercase;\n  letter-spacing: 0.1em;\n}\n.badge-name {\n  font-size: 0.82rem;\n  font-weight: 800;\n  color: #1a2e1a;\n}\n:host-context(html.dark) .badge-name {\n  color: #e2e8f0;\n}\n.badge-desc {\n  font-size: 0.7rem;\n  color: #6b7280;\n  line-height: 1.4;\n}\n:host-context(html.dark) .badge-desc {\n  color: #94a3b8;\n}\n.badge-date {\n  font-size: 0.65rem;\n  font-weight: 600;\n  color: #10b981;\n  margin-top: 2px;\n}\n/*# sourceMappingURL=achievement-gallery.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AchievementGalleryComponent, { className: "AchievementGalleryComponent", filePath: "src/app/features/achievements/achievement-gallery.component.ts", lineNumber: 229 });
})();
export {
  AchievementGalleryComponent
};
//# sourceMappingURL=chunk-RV6O7SU2.js.map

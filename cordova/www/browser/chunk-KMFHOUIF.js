...
var TOPIC_MAP = {
  "core-java": {
    "arrays": () => import("./chunk-Q2B6AWB4.js").then((m) => m.ArraysComponent),
    "strings": () => import("./chunk-RT5SRG2L.js").then((m) => m.StringsComponent),
    "oop-classes": () => import("./chunk-BCZ7CT6R.js").then((m) => m.OopClassesComponent),
    "inheritance": () => import("./chunk-ZSTLOS7T.js").then((m) => m.InheritanceComponent),
    "polymorphism": () => import("./chunk-NWKJBHZJ.js").then((m) => m.PolymorphismComponent),
    "abstraction": () => import("./chunk-NYCLLBK4.js").then((m) => m.AbstractionComponent),
    "encapsulation": () => import("./chunk-UWOIQVMX.js").then((m) => m.EncapsulationComponent),
    "exceptions": () => import("./chunk-3QPDA2ID.js").then((m) => m.ExceptionsComponent),
    "collections-list": () => import("./chunk-ZQ7IOLK2.js").then((m) => m.CollectionsListComponent),
    "collections-map": () => import("./chunk-HKPWUX5H.js").then((m) => m.CollectionsMapComponent),
    "generics": () => import("./chunk-F2WW7Y2B.js").then((m) => m.GenericsComponent),
    "streams": () => import("./chunk-JPTWLYIC.js").then((m) => m.StreamsComponent),
    "lambdas": () => import("./chunk-YO2XPT4H.js").then((m) => m.LambdasComponent),
    "records-sealed": () => import("./chunk-MVG6NZN3.js").then((m) => m.RecordsSealedComponent),
    "io-files": () => import("./chunk-MS2XZSTO.js").then((m) => m.IoFilesComponent)
  },
  "spring-framework": {
    "spring-ioc": () => import("./chunk-3LGJR3UY.js").then((m) => m.SpringIocComponent),
    "spring-di": () => import("./chunk-YMJVP7HT.js").then((m) => m.SpringDiComponent),
    "spring-beans": () => import("./chunk-5ISOANG3.js").then((m) => m.SpringBeansComponent),
    "spring-aop": () => import("./chunk-3GZEUE7P.js").then((m) => m.SpringAopComponent),
    "spring-mvc": () => import("./chunk-HBCG5AOT.js").then((m) => m.SpringMvcComponent),
    "spring-rest": () => import("./chunk-MB35D4JZ.js").then((m) => m.SpringRestComponent),
    "spring-data": () => import("./chunk-YLAJU5RT.js").then((m) => m.SpringDataComponent),
    "spring-security": () => import("./chunk-QNUWPD7S.js").then((m) => m.SpringSecurityComponent),
    "spring-config": () => import("./chunk-J56CRBSM.js").then((m) => m.SpringConfigComponent),
    "spring-testing": () => import("./chunk-WREYMOJV.js").then((m) => m.SpringTestingComponent),
    "spring-events": () => import("./chunk-SSO773HQ.js").then((m) => m.SpringEventsComponent),
    "spring-caching": () => import("./chunk-ABEU43G4.js").then((m) => m.SpringCachingComponent)
  },
  "spring-boot": {
    "sb-auto-config": () => import("./chunk-LPJOCL3V.js").then((m) => m.SbAutoConfigComponent),
    "sb-starters": () => import("./chunk-LQ5XYLOC.js").then((m) => m.SbStartersComponent),
    "sb-properties": () => import("./chunk-C2XITN3V.js").then((m) => m.SbPropertiesComponent),
    "sb-devtools": () => import("./chunk-2IQZWXBI.js").then((m) => m.SbDevtoolsComponent),
    "sb-actuator": () => import("./chunk-P6C2DWZI.js").then((m) => m.SbActuatorComponent),
    "sb-logging": () => import("./chunk-CFEKUWLA.js").then((m) => m.SbLoggingComponent),
    "sb-rest-api": () => import("./chunk-N4LUDVMW.js").then((m) => m.SbRestApiComponent),
    "sb-validation": () => import("./chunk-XM5HOYHE.js").then((m) => m.SbValidationComponent),
    "sb-exception": () => import("./chunk-JKIKIX4E.js").then((m) => m.SbExceptionComponent),
    "sb-data-jpa": () => import("./chunk-PBC3ZZGN.js").then((m) => m.SbDataJpaComponent),
    "sb-security": () => import("./chunk-BT3Y2RI7.js").then((m) => m.SbSecurityComponent),
    "sb-testing": () => import("./chunk-YWF6QDTS.js").then((m) => m.SbTestingComponent),
    "sb-profiles": () => import("./chunk-CZ5H5PFN.js").then((m) => m.SbProfilesComponent),
    "sb-docker": () => import("./chunk-HRRFKFEQ.js").then((m) => m.SbDockerComponent),
    "sb-caching": () => import("./chunk-U4F2YTV3.js").then((m) => m.SbCachingComponent),
    "sb-scheduling": () => import("./chunk-2WK3W2HS.js").then((m) => m.SbSchedulingComponent),
    "sb-events": () => import("./chunk-CLKWP6NT.js").then((m) => m.SbEventsComponent),
    "sb-deploy": () => import("./chunk-V2WQSSGN.js").then((m) => m.SbDeployComponent)
  },
  "hibernate": {
    "hib-orm": () => import("./chunk-GIJCRYY3.js").then((m) => m.HibOrmComponent),
    "hib-entities": () => import("./chunk-QTL7COXF.js").then((m) => m.HibEntitiesComponent),
    "hib-relations": () => import("./chunk-EETOEDAF.js").then((m) => m.HibRelationsComponent),
    "hib-jpql": () => import("./chunk-RUPMZOHB.js").then((m) => m.HibJpqlComponent),
    "hib-criteria": () => import("./chunk-PT6MWR2I.js").then((m) => m.HibCriteriaComponent),
    "hib-caching": () => import("./chunk-UF4DK363.js").then((m) => m.HibCachingComponent),
    "hib-transactions": () => import("./chunk-NBW36G7Q.js").then((m) => m.HibTransactionsComponent),
    "hib-performance": () => import("./chunk-FVSHDEXO.js").then((m) => m.HibPerformanceComponent),
    "hib-inheritance": () => import("./chunk-4OJA3K6H.js").then((m) => m.HibInheritanceComponent),
    "hib-auditing": () => import("./chunk-IGM6GUYH.js").then((m) => m.HibAuditingComponent)
  },
  "microservices": {
    "ms-intro": () => import("./chunk-KSBHM7X7.js").then((m) => m.MsIntroComponent),
    "ms-discovery": () => import("./chunk-YZH6QQM5.js").then((m) => m.MsDiscoveryComponent),
    "ms-gateway": () => import("./chunk-EMPWIROO.js").then((m) => m.MsGatewayComponent),
    "ms-config": () => import("./chunk-3E3U25R7.js").then((m) => m.MsConfigComponent),
    "ms-circuit": () => import("./chunk-LSKCDO6P.js").then((m) => m.MsCircuitComponent),
    "ms-loadbalance": () => import("./chunk-M24DD3KZ.js").then((m) => m.MsLoadbalanceComponent),
    "ms-communication": () => import("./chunk-SABFD4IA.js").then((m) => m.MsCommunicationComponent),
    "ms-events": () => import("./chunk-CRGCIHK3.js").then((m) => m.MsEventsComponent),
    "ms-saga": () => import("./chunk-LCADEZIL.js").then((m) => m.MsSagaComponent),
    "ms-cqrs": () => import("./chunk-S2QNG2TQ.js").then((m) => m.MsCqrsComponent),
    "ms-tracing": () => import("./chunk-UYX7H4U5.js").then((m) => m.MsTracingComponent),
    "ms-docker": () => import("./chunk-QXUUPJ7P.js").then((m) => m.MsDockerComponent),
    "ms-k8s": () => import("./chunk-AHEM7QLL.js").then((m) => m.MsK8sComponent),
    "ms-security": () => import("./chunk-TC3OIVRP.js").then((m) => m.MsSecurityComponent)
  },
  "multithreading": {
    "mt-threads": () => import("./chunk-2QMRNPQM.js").then((m) => m.MtThreadsComponent),
    "mt-sync": () => import("./chunk-XYPND5DN.js").then((m) => m.MtSyncComponent),
    "mt-executors": () => import("./chunk-Y5AZZARU.js").then((m) => m.MtExecutorsComponent),
    "mt-future": () => import("./chunk-HK5RCYKN.js").then((m) => m.MtFutureComponent),
    "mt-collections": () => import("./chunk-6CHK6QRY.js").then((m) => m.MtCollectionsComponent),
    "mt-locks": () => import("./chunk-V2UOQFFD.js").then((m) => m.MtLocksComponent),
    "mt-atomic": () => import("./chunk-7VGHOWMZ.js").then((m) => m.MtAtomicComponent),
    "mt-virtual": () => import("./chunk-PRH5UE2G.js").then((m) => m.MtVirtualComponent)
  },
  "design-patterns": {
    "dp-singleton": () => import("./chunk-PYWP4EKY.js").then((m) => m.DpSingletonComponent),
    "dp-factory": () => import("./chunk-2SIONSJ7.js").then((m) => m.DpFactoryComponent),
    "dp-builder": () => import("./chunk-DRWRDMHG.js").then((m) => m.DpBuilderComponent),
    "dp-observer": () => import("./chunk-WLU3OR25.js").then((m) => m.DpObserverComponent),
    "dp-strategy": () => import("./chunk-3STV6GHM.js").then((m) => m.DpStrategyComponent),
    "dp-decorator": () => import("./chunk-WJVD4R66.js").then((m) => m.DpDecoratorComponent),
    "dp-adapter": () => import("./chunk-ZTI5H3F7.js").then((m) => m.DpAdapterComponent),
    "dp-proxy": () => import("./chunk-H3KZDCJO.js").then((m) => m.DpProxyComponent),
    "dp-template": () => import("./chunk-54KIZFR4.js").then((m) => m.DpTemplateComponent),
    "dp-command": () => import("./chunk-6TPKPQGR.js").then((m) => m.DpCommandComponent),
    "dp-chain": () => import("./chunk-PUVLEOE3.js").then((m) => m.DpChainComponent),
    "dp-state": () => import("./chunk-3SH6KPSQ.js").then((m) => m.DpStateComponent)
  }
};
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;d6ca4685d2fd1b842c24a46346ee9d2489cdb863b553ef5c6e2fafbb4e8d6a80;/Users/sathishkumarramalingam/projects/JavaIQ/.claude/worktrees/goofy-haibt/src/app/features/tutorials/topic-router.component.ts */\n.topic-toolbar {\n  --background: #0b1120;\n  --color: white;\n  --border-style: none;\n}\n.topic-toolbar-title {\n  display: flex;\n  align-items: center;\n  gap: 6px;\n  font-size: 0.78rem !important;\n  font-weight: 600;\n  color: #94a3b8;\n  text-transform: capitalize;\n}\n.toolbar-sep {\n  opacity: 0.4;\n}\n.toolbar-topic-idx {\n  color: #64748b;\n  font-size: 0.7rem;\n}\n.tutorial-scroll-container {\n  display: block;\n  width: 100%;\n  height: auto;\n  padding-bottom: 40px;\n}\n.loading {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  min-height: 70vh;\n  gap: 20px;\n  color: #64748b;\n  font-size: 0.9rem;\n  font-weight: 600;\n}\n.spinner {\n  width: 36px;\n  height: 36px;\n  border: 3px solid rgba(255, 255, 255, 0.06);\n  border-top-color: #10b981;\n  border-radius: 50%;\n  animation: spin 0.75s cubic-bezier(0.4, 0, 0.2, 1) infinite;\n}\n@keyframes spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n.not-found {\n  text-align: center;\n  padding: 100px 32px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.not-found-icon {\n  font-size: 3rem;\n  margin-bottom: 24px;\n}\n.not-found h2 {\n  font-size: 1.6rem;\n  font-weight: 800;\n  color: #e2e8f0;\n  margin: 0 0 12px;\n}\n.not-found p {\n  font-size: 0.9rem;\n  color: #64748b;\n  line-height: 1.6;\n  margin: 0 0 32px;\n  max-width: 280px;\n}\n.back-link {\n  display: inline-flex;\n  align-items: center;\n  gap: 8px;\n  font-size: 0.85rem;\n  color: #10b981;\n  text-decoration: none;\n  font-weight: 700;\n  padding: 12px 24px;\n  background: rgba(16, 185, 129, 0.12);\n  border: 1px solid rgba(16, 185, 129, 0.25);\n  border-radius: 14px;\n  transition: transform 0.2s;\n}\n.back-link:active {\n  transform: scale(0.96);\n}\n.nav-bar {\n  position: fixed;\n  bottom: var(--admob-banner-height, 0px);\n  left: 0;\n  right: 0;\n  z-index: 100;\n  background: rgba(11, 17, 32, 0.96);\n  backdrop-filter: blur(20px);\n  -webkit-backdrop-filter: blur(20px);\n  border-top: 1px solid rgba(255, 255, 255, 0.07);\n  padding-bottom: env(safe-area-inset-bottom, 0);\n}\n.progress-strip {\n  height: 3px;\n  background: rgba(255, 255, 255, 0.05);\n  overflow: hidden;\n}\n.progress-fill {\n  height: 100%;\n  background:\n    linear-gradient(\n      90deg,\n      #10b981,\n      #34d399);\n  transition: width 0.5s ease;\n}\n.nav-row {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 10px;\n  padding: 10px 16px;\n}\n.nav-btn {\n  display: inline-flex;\n  align-items: center;\n  gap: 6px;\n  padding: 10px 14px;\n  border-radius: 12px;\n  font-size: 0.72rem;\n  font-weight: 700;\n  text-decoration: none;\n  color: #94a3b8;\n  background: rgba(255, 255, 255, 0.04);\n  border: 1px solid rgba(255, 255, 255, 0.07);\n  transition: all 0.2s ease;\n  min-width: 80px;\n  outline: none;\n}\n.nav-btn:hover {\n  color: #e2e8f0;\n  background: rgba(255, 255, 255, 0.08);\n}\n.nav-btn:active {\n  transform: scale(0.96);\n}\n.nav-btn.disabled {\n  opacity: 0.45;\n  pointer-events: none;\n}\n.nav-btn-icon {\n  font-size: 0.65rem;\n}\n.nav-prev {\n  justify-content: flex-start;\n}\n.nav-next {\n  justify-content: flex-end;\n}\n.complete-btn {\n  display: inline-flex;\n  align-items: center;\n  gap: 7px;\n  padding: 11px 18px;\n  border-radius: 12px;\n  font-size: 0.75rem;\n  font-weight: 700;\n  letter-spacing: 0.01em;\n  border: none;\n  cursor: pointer;\n  transition: all 0.2s ease;\n  background: rgba(16, 185, 129, 0.15);\n  color: #34d399;\n  border: 1px solid rgba(16, 185, 129, 0.3);\n  flex: 1;\n  justify-content: center;\n  max-width: 160px;\n}\n.complete-btn:hover {\n  background: rgba(16, 185, 129, 0.25);\n  transform: scale(1.02);\n}\n.complete-btn:active {\n  transform: scale(0.97);\n}\n.complete-btn-done {\n  background: rgba(16, 185, 129, 0.08) !important;\n  color: #10b981 !important;\n  border-color: rgba(16, 185, 129, 0.2) !important;\n  cursor: default !important;\n}\n.complete-icon {\n  font-size: 0.85rem;\n}\n:host-context(html:not(.dark)) .topic-toolbar {\n  --background: #1B4332;\n  --color: white;\n}\n/*# sourceMappingURL=topic-router.component.css.map */\n"] }]
  }], null, { outlet: [{
    type: ViewChild,
...
//# sourceMappingURL=chunk-KMFHOUIF.js.map

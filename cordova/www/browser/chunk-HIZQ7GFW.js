import{a as k,b as h,c as S}from"./chunk-T5DA2T3H.js";import{$ as u,$a as e,Ia as f,Xa as b,Ya as C,Za as o,_a as t,aa as g,ab as c,hb as x,jb as v,lb as m,ma as d,tb as y,wb as i,xb as p,za as n}from"./chunk-GF54RO5Y.js";import"./chunk-NWJ5J3BN.js";var M=(l,s)=>s.name;function P(l,s){if(l&1){let r=x();t(0,"div",16),v("click",function(){let E=u(r).$implicit,_=m();return g(_.selectCb(E.name))}),t(1,"span",17),i(2),e(),t(3,"span",18),i(4),e()()}if(l&2){let r=s.$implicit,a=m();y("active",a.activeCb()===r.name),n(2),p(r.icon),n(2),p(r.name)}}var O=class l{activeCb=d("");cbStatus=d("Click a state to learn about circuit breaker transitions.");cbStates=d([{name:"CLOSED",icon:"\u2705"},{name:"OPEN",icon:"\u{1F534}"},{name:"HALF_OPEN",icon:"\u{1F7E1}"}]);codeIntro=`@Service

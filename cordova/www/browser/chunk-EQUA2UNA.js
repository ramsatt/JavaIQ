import{a as h,b as S}from"./chunk-FDH3XGHK.js";import{a as k}from"./chunk-IWR5KZXO.js";import{$ as g,Ba as n,Ma as f,_ as u,ab as b,bb as C,cb as o,db as t,eb as e,fb as c,ka as d,lb as x,mb as v,nb as m,vb as y,xb as i,yb as p}from"./chunk-AMBX34QR.js";import"./chunk-NWJ5J3BN.js";var M=(l,s)=>s.name;function P(l,s){if(l&1){let r=x();t(0,"div",16),v("click",function(){let E=u(r).$implicit,_=m();return g(_.selectCb(E.name))}),t(1,"span",17),i(2),e(),t(3,"span",18),i(4),e()()}if(l&2){let r=s.$implicit,a=m();y("active",a.activeCb()===r.name),n(2),p(r.icon),n(2),p(r.name)}}var O=class l{activeCb=d("");cbStatus=d("Click a state to learn about circuit breaker transitions.");cbStates=d([{name:"CLOSED",icon:"\u2705"},{name:"OPEN",icon:"\u{1F534}"},{name:"HALF_OPEN",icon:"\u{1F7E1}"}]);codeIntro=`@Service

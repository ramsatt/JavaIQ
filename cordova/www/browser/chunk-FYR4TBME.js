...
var ExpDetailComponent = class _ExpDetailComponent {
  ...
  constructor() {
    this.route.paramMap.subscribe((params) => {
      this.expId.set(params.get("id") ?? "");
    });
  }
  static \u0275fac = function ExpDetailComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ExpDetailComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExpDetailComponent, selectors: [["app-exp-detail"]], decls: 15, vars: 0, consts: [[1, "ion-no-border"], ["slot", "start"], ["defaultHref", "/experiences", "text", ""], [1, "px-4", "pt-6", "pb-24"], [1, "card", "p-8", "text-center"], [1, "w-16", "h-16", "rounded-2xl", "bg-[#eef2ff]", "flex", "items-center", "justify-center", "mx-auto", "mb-4", "text-3xl"], [1, "text-xl", "font-extrabold", "text-[#0f172a]", "mb-2"], [1, "text-[#64748b]", "text-sm", "leading-relaxed", "max-w-xs", "mx-auto"]], template: function ExpDetailComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(12, "Full Interview Story");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "p", 7);
      \u0275\u0275text(14, " Round-by-round breakdown, questions asked, preparation tips, and final outcome. ");
      \u0275\u0275elementEnd()()()();
    }
    ...
    <ion-content>
      <div class="px-4 pt-6 pb-24">
        <div class="card p-8 text-center">
          <div class="w-16 h-16 rounded-2xl bg-[#eef2ff] flex items-center justify-center mx-auto mb-4 text-3xl">\u{1F3A4}</div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ExpDetailComponent, { className: "ExpDetailComponent", filePath: "src/app/features/experiences/exp-detail.component.ts", lineNumber: 32 });
})();
export {
  ExpDetailComponent
};
//# sourceMappingURL=chunk-FYR4TBME.js.map

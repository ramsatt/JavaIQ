import{a as k,b as h,c as S}from"./chunk-4EMTR65D.js";import{$ as g,Gb as y,Ib as i,Jb as p,Na as n,Ya as f,_ as u,la as d,lb as b,mb as C,nb as o,ob as t,pb as e,qb as c,wb as x,xb as v,yb as m}from"./chunk-X3QUIMOS.js";import"./chunk-NWJ5J3BN.js";var M=(l,s)=>s.name;function P(l,s){if(l&1){let r=x();t(0,"div",16),v("click",function(){let E=u(r).$implicit,_=m();return g(_.selectCb(E.name))}),t(1,"span",17),i(2),e(),t(3,"span",18),i(4),e()()}if(l&2){let r=s.$implicit,a=m();y("active",a.activeCb()===r.name),n(2),p(r.icon),n(2),p(r.name)}}var O=class l{activeCb=d("");cbStatus=d("Click a state to learn about circuit breaker transitions.");cbStates=d([{name:"CLOSED",icon:"\u2705"},{name:"OPEN",icon:"\u{1F534}"},{name:"HALF_OPEN",icon:"\u{1F7E1}"}]);codeIntro=`@Service

...
function ExpListComponent_For_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 42);
    \u0275\u0275listener("click", function ExpListComponent_For_40_Template_button_click_0_listener() {
...
function ExpListComponent_For_47_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 43);
    \u0275\u0275listener("click", function ExpListComponent_For_47_Template_button_click_0_listener() {
...
function ExpListComponent_For_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 43);
    \u0275\u0275listener("click", function ExpListComponent_For_53_Template_button_click_0_listener() {
...
function ExpListComponent_For_63_For_27_Template(rf, ctx) {
  if (rf & 1) {
...
function ExpListComponent_For_63_Conditional_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 63);
  }
}
function ExpListComponent_For_63_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 64);
  }
}
function ExpListComponent_For_63_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 44);
    \u0275\u0275listener("click", function ExpListComponent_For_63_Template_button_click_0_listener() {
    ...
    \u0275\u0275element(4, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 48)(6, "div", 49)(7, "div", 50)(8, "span", 51);
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(26, ExpListComponent_For_63_For_27_Template, 2, 1, "span", 61, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 62);
    \u0275\u0275conditionalCreate(29, ExpListComponent_For_63_Conditional_29_Template, 1, 0, "i", 63)(30, ExpListComponent_For_63_Conditional_30_Template, 1, 0, "i", 64);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function ExpListComponent_Conditional_64_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ExpListComponent_Conditional_64_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
...
var ExpListComponent = class _ExpListComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ExpListComponent, selectors: [["app-exp-list"]], decls: 75, vars: 4, consts: [["translucent", "true", 1, "ion-no-border"], [1, "exp-toolbar"], ["slot", "start"], ["color", "light"], [1, "exp-content"], [1, "hero"], [1, "hero-glow", "g1"], [1, "hero-glow", "g2"], [1, "hero-inner"], [1, "hero-badge"], [1, "fa-solid", "fa-microphone-lines", "hero-badge-icon"], [1, "hero-title"], [1, "hero-accent"], [1, "hero-sub"], [1, "hero-stats"], [1, "hero-stat"], [1, "stat-num"], [1, "stat-lbl"], [1, "stat-div"], [1, "body"], [1, "filter-scroll"], [1, "cpill", 3, "cpill-active"], [1, "filter-row2"], [1, "filter-group"], [1, "filter-label"], [1, "filter-chips"], [1, "schip", 3, "schip-active", "--chip-color"], [1, "section-head"], [1, "sh-left"], [1, "fa-solid", "fa-briefcase", "sh-icon"], [1, "sh-title"], [1, "sh-count"], [1, "card-list"], [1, "exp-card"], [1, "empty-state"], [1, "cta-card"], [1, "cta-icon-wrap"], [1, "fa-solid", "fa-pen-to-square", "cta-icon"], [1, "cta-title"], [1, "cta-sub"], [1, "cta-btn"], [1, "fa-solid", "fa-plus"], [1, "cpill", 3, "click"], [1, "schip", 3, "click"], [1, "exp-card", 3, "click"], [1, "exp-accent"], [1, "exp-card-inner"], [1, "exp-logo"], [1, "exp-info"], [1, "exp-top"], [1, "exp-title-group"], [1, "exp-company"], [1, "exp-role"], [1, "result-badge"], [1, "exp-meta"], [1, "meta-pill"], [1, "fa-solid", "fa-rotate", "meta-icon"], [1, "fa-solid", "fa-user-tie", "meta-icon"], [1, "diff-badge"], [1, "exp-date"], [1, "tag-row"], [1, "tag-chip"], [1, "exp-arrow-container"], [1, "fa-solid", "fa-chevron-right", "exp-arrow"], [1, "fa-solid", "fa-lock", 2, "color", "#f59e0b", "font-size", "11px"], [1, "fa-solid", "fa-magnifying-glass", "empty-icon"], [1, "empty-text"], [1, "clear-btn", 3, "click"]], template: function ExpListComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(39, ExpListComponent_For_40_Template, 2, 3, "button", 21, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "div", 22)(42, "div", 23)(43, "span", 24);
      \u0275\u0275text(44, "Difficulty");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(45, "div", 25);
      \u0275\u0275repeaterCreate(46, ExpListComponent_For_47_Template, 2, 5, "button", 26, _forTrack0);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(48, "div", 23)(49, "span", 24);
      \u0275\u0275text(50, "Result");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "div", 25);
      \u0275\u0275repeaterCreate(52, ExpListComponent_For_53_Template, 2, 5, "button", 26, _forTrack0);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(54, "div", 27)(55, "div", 28);
      \u0275\u0275element(56, "i", 29);
      \u0275\u0275elementStart(57, "span", 30);
      \u0275\u0275text(58, "Interview Stories");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "span", 31);
      \u0275\u0275text(60);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(61, "div", 32);
      \u0275\u0275repeaterCreate(62, ExpListComponent_For_63_Template, 31, 18, "button", 33, _forTrack1);
      \u0275\u0275conditionalCreate(64, ExpListComponent_Conditional_64_Template, 6, 0, "div", 34);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(65, "div", 35)(66, "div", 36);
      \u0275\u0275element(67, "i", 37);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(68, "h3", 38);
      \u0275\u0275text(69, "Share Your Story");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "p", 39);
      \u0275\u0275text(71, "Help fellow Java developers by sharing your interview experience");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(72, "button", 40);
      \u0275\u0275element(73, "i", 41);
      \u0275\u0275text(74, " Submit Experience ");
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(22);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275conditional(ctx.filtered().length === 0 ? 64 : -1);
    }
